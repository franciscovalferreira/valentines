  ...
  render() {
    return <div className="Home-container">
        ...
        <Container>
          <Row>
            <Col>
              <div onClick={this.show} className="footer fixed-bottom Home-alert"> <i className="fa fa-info-circle"></i> &nbsp;Quer saber mais sobre as sorte e simpatias a Santo António? Veja <span style={{
                fontWeight:"bold",
